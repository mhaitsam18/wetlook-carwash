<x-layout>
    ...
    <div class="account_dashboard">
        <div class="container">
            ...
            <form action="/member/vehicle/{{ $vehicle->id }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="row">
                    <div class="default-form-box mb-20 col-lg-6 col-sm-6">
                        ...
                        <input type="text" name="plate_number" id="plate_number"
                            value="{{ old('plate_number', $vehicle->plate_number) }}" placeholder="cth. A 1234 BCD">
                        @error('plate_number')
                    ...
                    <div class="default-form-box mb-20  col-lg-6 col-sm-6">
                        ...
                        <select name="type" id="type" class="w-100">
                            ...
                            <option value="motorcycle" @selected('motorcycle' == old('type', $vehicle->type))>Motor</option>
                            <option value="car" @selected('car' == old('type', $vehicle->type))>Mobil</option>
                        </select>
                        @error('type')
                            <div class="text-danger fs-6">
                                {{ $message }}
                    ...
                    <div class="default-form-box mb-20 col-lg-6 col-sm-6">
                        <img src="{{ asset('storage/' . $vehicle->image) }}" class="img-thumbnail img-preview"
