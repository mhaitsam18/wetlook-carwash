                ...
                <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                        <div class="row">
                            ...
                            <form class="row" action="/admin/order/{{ $order->id }}/payment/{{ $payment->id }}"
                                method="post" enctype="multipart/form-data">
                                @method('put')
                                <div class="col-lg-6">
                                    @csrf
                                    <input type="hidden" name="order_id" id="order_id"
                                        value="{{ old('order_id', $payment->order_id) }}">
                                    <div class="row mb-3">
                                        <label for="amount" class="col-md-4 col-lg-3 col-form-label">Jumlah</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input name="amount" type="number"
                                                class="form-control @error('amount') is-invalid @enderror"
                                                id="amount" value="{{ old('amount', $payment->amount) }}">
                                            @error('amount')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="evidence" type="file"
                                                ...
                                                id="evidence" value="{{ old('evidence', $payment->evidence) }}">
                                            @error('evidence')
                                                <div class="text-danger fs-6">
                                                    {{ $message }}
                                                </div>
