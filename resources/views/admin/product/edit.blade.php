            ...
            <div class="col-12">
                <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <form class="row" action="/admin/product/{{ $product->id }}" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <img src="{{ $product->image ? asset('storage/' . $product->image) : '/assets/img/not-found.jpg' }}"
                                            alt="Gambar" style="max-width: 200px;" class="img-preview">
                                        @error('image')
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <select name="room_id"
                                            ...
                                            @foreach ($packages as $package)
                                                <option value="{{ $package->id }}" @selected($package->id == old('package_id', $product->package_id))>
                                                    {{ $package->name }}</option>
                                            @endforeach
                                        </select>
