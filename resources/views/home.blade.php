        ...
        <div class="offcanvas-mobile-menu-wrapper">
            ...
            <div class="mobile-menu-top">
                ...
                <ul class="mobile-menu-user-menu">
                    <li><a class="header-user-menu-link" href=""><i class="icon-repeat"></i>Compare (0)</a>
                    </li>
                    ...
                    <li class="has-mobile-user-dropdown">
                        ...
                        <!-- Header Top Menu's Dropdown -->
                        <ul class="mobile-user-sub-menu">
                            <li><a href=""><img class="user-sub-menu-link-icon" src="/images/icon/lang-en.png"
                                        alt=""> English</a></li>
                            <li><a href=""><img class="user-sub-menu-link-icon" src="/images/icon/lang-gr.png"
                                        alt=""> Germany</a></li>
                        </ul>
                    </li>
                </ul> <!-- End Header Top Menu -->
        ...
        <div class="offcanvas-add-cart-wrapper">
            ...
            <ul class="offcanvas-cart">
                <li class="offcanvas-cart-item-single">
                    <div class="offcanvas-cart-item-block">
                        <a href="" class="offcanvas-cart-item-image-link">
                            <img src="/images/products_images/aments_products_image_6.jpg" alt=""
                ...
                <li class="offcanvas-cart-item-single">
                    <div class="offcanvas-cart-item-block">
                        <a href="" class="offcanvas-cart-item-image-link">
                            <img src="/images/categories_images/aments_categories_08.jpg" alt=""
                                class="offcanvas-cart-image">
                        </a>
                        <div class="offcanvas-cart-item-content">
                ...
                <li class="offcanvas-cart-item-single">
                    <div class="offcanvas-cart-item-block">
                        <a href="" class="offcanvas-cart-item-image-link">
                            <img src="/images/products_images/aments_products_image_2.jpg" alt=""
                                class="offcanvas-cart-image">
                        </a>
                        <div class="offcanvas-cart-item-content">
            ...
            <ul class="offcanvas-cart-action-button">
                <li class="offcanvas-cart-action-button-list"><a href=""
                        class="offcanvas-cart-action-button-link">View
                        Cart</a></li>
                <li class="offcanvas-cart-action-button-list"><a href=""
        ...
        <div class="offcanvas-wishlist-wrapper">
            ...
            <ul class="offcanvas-wishlist-action-button">
                <li class="offcanvas-wishlist-action-button-list"><a href=""
                        class="offcanvas-wishlist-action-button-link">View wishlist</a></li>
            </ul>
        </div> <!-- End Offcanvas Mobile Menu Wrapper -->
        ...
        <div class="hero-area-wrapper hero-slider-dots fix-slider-dots">
            ...
            <div class="hero-area-single">
                <div class="hero-area-bg">
                    <img class="hero-img" src="/images/slider_images/home_1/aments_home_1_slider_1.jpg"
                        alt="">
                </div>
            ...
            <div class="hero-area-single">
                <div class="hero-area-bg">
                    <img class="hero-img" src="/images/slider_images/home_1/aments_home_1_slider_2.jpg"
                        alt="">
                </div>
                <div class="hero-content">
                    <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        ...
                        <a href="product-details-default.html" class="product-catagory-single" data-aos="fade-up"
                            data-aos-delay="0">
                            <div class="product-catagory-img">
                                <img src="/images/categories_images/aments_categories_01.jpg" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        ...
                        <a href="product-details-default.html" class="product-catagory-single" data-aos="fade-up"
                            data-aos-delay="200">
                            <div class="product-catagory-img">
                                <img src="/images/categories_images/aments_categories_02.jpg" alt="">
                            </div>
                            <div class="product-catagory-content">
                                <h5 class="product-catagory-title">Parts Box</h5>
                                <span class="product-catagory-items">(20 Items)</span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        ...
                        <a href="product-details-default.html" class="product-catagory-single" data-aos="fade-up"
                            data-aos-delay="400">
                            <div class="product-catagory-img">
                                <img src="/images/categories_images/aments_categories_03.jpg" alt="">
                            </div>
                            <div class="product-catagory-content">
                                <h5 class="product-catagory-title">Parts Box</h5>
                                <span class="product-catagory-items">(20 Items)</span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        ...
                        <a href="product-details-default.html" class="product-catagory-single" data-aos="fade-up"
                            data-aos-delay="600">
                            <div class="product-catagory-img">
                                <img src="/images/categories_images/aments_categories_04.jpg" alt="">
                            </div>
                            <div class="product-catagory-content">
                                <h5 class="product-catagory-title">Parts Box</h5>
                                <span class="product-catagory-items">(20 Items)</span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        ...
                        <a href="product-details-default.html" class="product-catagory-single" data-aos="fade-up"
                            data-aos-delay="0">
                            <div class="product-catagory-img">
                                <img src="/images/categories_images/aments_categories_05.jpg" alt="">
                            </div>
                            <div class="product-catagory-content">
                                <h5 class="product-catagory-title">Parts Box</h5>
                                <span class="product-catagory-items">(20 Items)</span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        ...
                        <a href="product-details-default.html" class="product-catagory-single" data-aos="fade-up"
                            data-aos-delay="200">
                            <div class="product-catagory-img">
                                <img src="/images/categories_images/aments_categories_06.jpg" alt="">
                            </div>
                            <div class="product-catagory-content">
                                <h5 class="product-catagory-title">Parts Box</h5>
                                <span class="product-catagory-items">(20 Items)</span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        ...
                        <a href="product-details-default.html" class="product-catagory-single" data-aos="fade-up"
                            data-aos-delay="400">
                            <div class="product-catagory-img">
                                <img src="/images/categories_images/aments_categories_07.jpg" alt="">
                            </div>
                            <div class="product-catagory-content">
                                <h5 class="product-catagory-title">Parts Box</h5>
                                <span class="product-catagory-items">(20 Items)</span>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="banner-single" data-aos="fade-up" data-aos-delay="0">
                            <a href="product-details-default.html" class="banner-img-link">
                                <img class="banner-img" src="/images/banner_images/aments_banner_01.jpg"
                                    alt="">
                            </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="banner-single" data-aos="fade-up" data-aos-delay="200">
                            <a href="product-details-default.html" class="banner-img-link">
                                <img class="banner-img" src="/images/banner_images/aments_banner_02.jpg"
                                    alt="">
                            </a>
                            <div class="banner-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="banner-single" data-aos="fade-up" data-aos-delay="400">
                            <a href="product-details-default.html" class="banner-img-link">
                                <img class="banner-img" src="/images/banner_images/aments_banner_03.jpg"
                                    alt="">
                            </a>
                            <div class="banner-content">
                                <span class="banner-text-tiny">Car Vails</span>
                ...
                <div class="row">
                    <div
                        ...
                        <ul class="tablist nav product-tab-btn" data-aos="fade-up" data-aos-delay="400">
                            <li><a class="nav-link active" data-toggle="tab" href="#car_and_drive">Car & Drive </a>
                            </li>
                            ...
                            <div class="tab-pane show active" id="car_and_drive">
                                <div class="product-default-slider product-default-slider-4grids-1row">
                                    ...
                                    <div class="product-default-single border-around">
                                        <div class="product-img-warp">
                                            <a href="product-details-default.html" class="product-default-img-link">
                                                <img src="/images/products_images/aments_products_image_2.jpg"
                                            ...
                                            <div class="product-action-icon-link">
                                                <ul>
                                                    ...
                                                    <li><a href="#" data-toggle="modal"
                                                            data-target="#modalQuickview"><i class="icon-eye"></i></a>
                                                    </li>
                                                    <li><a href="#" data-toggle="modal"
                                        ...
                                        <div class="product-default-content">
                                            <h6 class="product-default-link"><a
                                                    href="product-details-default.html">New
                                    ...
                                    <div class="product-default-single border-around">
                                        <div class="product-img-warp">
                                            <a href="product-details-default.html" class="product-default-img-link">
                                                <img src="/images/products_images/aments_products_image_1.jpg"
                                                    alt="" class="product-default-img img-fluid">
                                            </a>
                                            <div class="product-action-icon-link">
                                                <ul>
                                    ...
                                    <div class="product-default-single border-around">
                                        <div class="product-img-warp">
                                            <a href="product-details-default.html" class="product-default-img-link">
                                                <img src="/images/products_images/aments_products_image_4.jpg"
                                                    alt="" class="product-default-img img-fluid">
                                            </a>
                                            <div class="product-action-icon-link">
                                                <ul>
                                    ...
                                    <div class="product-default-single border-around">
                                        <div class="product-img-warp">
                                            <a href="product-details-default.html" class="product-default-img-link">
                                                <img src="/images/products_images/aments_products_image_3.jpg"
                                                    alt="" class="product-default-img img-fluid">
                                            </a>
                                            <div class="product-action-icon-link">
                                                <ul>
                                    ...
                                    <div class="product-default-single border-around">
                                        <div class="product-img-warp">
                                            <a href="product-details-default.html" class="product-default-img-link">
                                                <img src="/images/products_images/aments_products_image_6.jpg"
                                                    alt="" class="product-default-img img-fluid">
                                            </a>
                                            <div class="product-action-icon-link">
                                                <ul>
                                    ...
                                    <div class="product-default-single border-around">
                                        <div class="product-img-warp">
                                            <a href="product-details-default.html" class="product-default-img-link">
                                                <img src="/images/products_images/aments_products_image_5.jpg"
                                                    alt="" class="product-default-img img-fluid">
                                            </a>
                                            <div class="product-action-icon-link">
                                                <ul>
                                    ...
                                    <div class="product-default-single border-around">
                                        <div class="product-img-warp">
                                            <a href="product-details-default.html" class="product-default-img-link">
                                                <img src="/images/products_images/aments_products_image_8.jpg"
                                                    alt="" class="product-default-img img-fluid">
                                            </a>
                                            <div class="product-action-icon-link">
                                                <ul>
                                    ...
                                    <div class="product-default-single border-around">
                                        <div class="product-img-warp">
                                            <a href="product-details-default.html" class="product-default-img-link">
                                                <img src="/images/products_images/aments_products_image_7.jpg"
                                                    alt="" class="product-default-img img-fluid">
                                            </a>
                                            <div class="product-action-icon-link">
                                                <ul>
                        ...
                        <div class="banner-single" data-aos="fade-up" data-aos-delay="0">
                            <a href="product-details-default.html" class="banner-img-link">
                                <img class="banner-img banner-img-big"
                                    src="/images/banner_images/aments_big-banner.jpg" alt="">
                            </a>
                            <div class="banner-content">
                                <span class="banner-text-small">2021 Latest Collection</span>
                                <h2 class="banner-text-big"><span class="banner-text-big-highlight">-40%</span>
                                    Offer
                                    All Car Parts</h2>
                            </div>
                        </div> <!-- End Banner Single -->
                ...
                <div class="row">
                    <div
                        ...
                        <ul class="tablist nav product-tab-btn" data-aos="fade-up" data-aos-delay="200">
                            <li><a class="nav-link active" data-toggle="tab" href="#drive_and_car">Drive & Car
                                </a></li>
                    ...
                    <div class="col-12">
                        <div class="company-logo-slider">
                            ...
                            <div class="company-logo-single">
                                <img src="/images/company_logo/company_logo_1.png" alt=""
                                    class="img-fluid company-logo-image">
                            </div> <!-- End Company logo Single -->
                            <!-- Start Company logo Single -->
                            <div class="company-logo-single">
                                <img src="/images/company_logo/company_logo_2.png" alt=""
                                    class="img-fluid company-logo-image">
                            </div> <!-- End Company logo Single -->
                            <!-- Start Company logo Single -->
                            <div class="company-logo-single">
                                <img src="/images/company_logo/company_logo_3.png" alt=""
                                    class="img-fluid company-logo-image">
                            </div> <!-- End Company logo Single -->
                            <!-- Start Company logo Single -->
                            <div class="company-logo-single">
                                <img src="/images/company_logo/company_logo_4.png" alt=""
                                    class="img-fluid company-logo-image">
                            </div> <!-- End Company logo Single -->
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="blog-feed-single" data-aos="fade-up" data-aos-delay="0">
                            <a href="blog-single-sidebar-left.html" class="blog-feed-img-link">
                                <img src="/images/blog_images/aments_blog_01.jpg" alt=""
                                    class="blog-feed-img">
                            </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="blog-feed-single" data-aos="fade-up" data-aos-delay="400">
                            <a href="blog-single-sidebar-left.html" class="blog-feed-img-link">
                                <img src="/images/blog_images/aments_blog_02.jpg" alt=""
                                    class="blog-feed-img">
                            </a>
                            <div class="blog-feed-content">
                                <div class="blog-feed-post-meta">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="blog-feed-single" data-aos="fade-up" data-aos-delay="600">
                            <a href="blog-single-sidebar-left.html" class="blog-feed-img-link">
                                <img src="/images/blog_images/aments_blog_03.jpg" alt=""
                                    class="blog-feed-img">
                            </a>
                            <div class="blog-feed-content">
                                <div class="blog-feed-post-meta">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-5">
                        <div class="footer-widget footer-widget-contact" data-aos="fade-up" data-aos-delay="0">
                            <div class="footer-logo">
                                <a href="index.html"><img src="/images/logo/logo.png" alt=""
                                        class="img-fluid"></a>
                            </div>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-7">
                        <div class="footer-widget footer-widget-subscribe" data-aos="fade-up"
                            data-aos-delay="200">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="modal-add-cart-product-img">
                                            <img class="img-fluid"
                                                src="/images/products_images/aments_products_image_1.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-6">
                                <div class="product-details-gallery-area">
                                    <div class="product-large-image modal-product-image-large">
                                        ...
                                        <div class="product-image-large-single">
                                            <img class="img-fluid"
                                                src="/images/products_images/aments_products_image_2.jpg"
                                                alt="">
                                        </div>
                                        <div class="product-image-large-single">
                                            <img class="img-fluid"
                                                src="/images/products_images/aments_products_image_3.jpg"
                                                alt="">
                                        </div>
                                        <div class="product-image-large-single">
                                            <img class="img-fluid"
                                                src="/images/products_images/aments_products_image_4.jpg"
                                                alt="">
                                        </div>
                                        <div class="product-image-large-single">
                                            <img class="img-fluid"
                                                src="/images/products_images/aments_products_image_5.jpg"
                                                alt="">
                                        </div>
                                        <div class="product-image-large-single">
                                            <img class="img-fluid"
                                                src="/images/products_images/aments_products_image_6.jpg"
                                                alt="">
                                        </div>
                                    </div>
